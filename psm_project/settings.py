"""
Django settings for psm_project project.
...
SECRET_KEY = 'django-insecure-qnr6n5chshh!rrt#qsp(ac8q0%pn$lxz)9d_(rjy=(#lw-*d2x'
...
WSGI_APPLICATION = 'psm_project.wsgi.application'
